<%@ Page MasterPageFile="~/Site1.Master"  Language="C#" AutoEventWireup="true" CodeBehind="CatalogoAcciones.aspx.cs" Inherits="Portal_Investigadores.CatalogoAcciones" %>
    ...
    <form runat="server">
        ...
        <div class="container">
            <div class="row" style="margin-top:21px;">
                <div id="lbl1" class="table-header" style="padding-bottom: 27px; text-align: center;">Configuración de Catalogo Acciones</div>
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <p id="lbl2" style="text-align: center;">Acciones</p>
                        </div>
                        <div class="card-body">
                            <div class="form-group col-md-12">
                                <label id="lbl3">Acción</label>
                                <asp:TextBox runat="server" ID="txtAccion" CssClass="form-control" />
                            </div>
                            <div class="form-group col-md-12">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <p id="lbl11" style="text-align: center;">Lista de Acciones</p>
                        </div>
                        <div class="card-body">
                            <div style="overflow-y:scroll; height:200px">
                                <asp:GridView OnSelectedIndexChanged="accionesGV_SelectedIndexChanged" ShowHeaderWhenEmpty="true" CssClass="strip table-dashboard table-hover table" runat="server" ID="accionesGV" AutoGenerateColumns="false">
                                <Columns>
                                    <asp:TemplateField>
                                         <ItemTemplate>
