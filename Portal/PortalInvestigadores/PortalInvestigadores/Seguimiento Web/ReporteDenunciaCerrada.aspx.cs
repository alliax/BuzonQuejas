...
{
    public partial class ReporteDenunciaCerrada : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                int acceso = ValidarAccesoCerradas(id, int.Parse(Session["idUsuario"].ToString()));
        ...
        protected int ValidarAccesoCerradas(int idDenuncia, int idUsuario)
        {
            int tipoAsignacion = DBHelper.getAccesoCerradas(idDenuncia, idUsuario);
        ...
        [WebMethod]
        public static string CargarSoportesCerradas(int id)
        {
            DBHelper DBHelper = new DBHelper();

            DataTable soportes = DBHelper.getSoportesCerradas(id);
